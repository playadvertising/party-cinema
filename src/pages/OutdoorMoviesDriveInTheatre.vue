    ...
    <div 
      ...
      h-full w-full rounded-md z-10 ">
        <ul class="list-disc">
          ...
          <li>Ultra-high 20,000 Lumen HD Projection</li>
          <li>Drive-in Audio FM Transmitter for in-vehicle radio reception</li>
          <li>Speaker for general announcments</li>
          ...
          <li>Incidental equipment (media player, mic, cables etc)</li>
          <li>Promotional event posters (printed and digital - on request)</li>
    ...
    <div 
      ...
      h-full w-full rounded-md z-10 ">
        <ul class="list-disc">
          ...
          <li>Promotional event posters (printed and digital - on request)</li>
          <li>Back-up equipment!</li>
          <li>Complete Snack bar (we sell snacks)</li>
          <li>Popcorn machine w/supplies rental (you operate)</li>
        </ul>
      </div>
  </div>
